...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Responda automaticamente aos comentários no Instagram com DMs personalizadas.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/80bba331-3472-4f81-8a46-19e0dee9ae73/id-preview-677b41ab--d297c914-2c04-4ec0-887c-646822fbefef.lovable.app-1782482021442.png",
      },
      {
        name: "twitter:image",
        content:
